...
from .choices import (
    ...
    PAIS_CHOICES, BARRIO_CHOICES, DISCAPACIDAD_CHOICES,
...
class Docente(models.Model):
    ...
    area_encargada = models.CharField(max_length=50, blank=True, null=True)
...
class DatosComplementarios(models.Model):
    ...
    discapacidad = models.CharField(max_length=20, choices=DISCAPACIDAD_CHOICES, default="No")
    tipo_discapacidad = models.CharField(max_length=50, choices=DISCAPACIDAD_CHOICES[1:], blank=True, null=True)
...
class Acudiente(models.Model):
    ...
    telefono = models.CharField(
        max_length=15,
        validators=[RegexValidator(regex=r'^\\d{7,15}$', message="El teléfono debe contener solo números.")],
...
class CursoExtendido(models.Model):
    ...
    def __str__(self):
        return f"{self.tipo_curso} - {self.disciplina}"
